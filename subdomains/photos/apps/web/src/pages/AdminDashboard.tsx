...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">      <Navbar />      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-sm sm:text-base"
                  />
                  <p className="text-xs text-gray-500 mt-1">Leave empty to create a public event without password protection</p>
                </div>
              </div>
              <button
                type="submit"
            ...
            {events.map((event) => (
              <div key={event.id} className="bg-white rounded-lg shadow-md p-4 sm:p-6">
                ...
                <Link
                  ...
                  className="inline-block w-full sm:w-auto text-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 active:bg-blue-800 transition text-sm"
                >
                  Upload Photos
                </Link>
              </div>
