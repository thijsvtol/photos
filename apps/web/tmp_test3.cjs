...
(async () => {
  ...
  await page.addInitScript(() => {
    ...
    Element.prototype.scrollIntoView = function(...args) {
      console.log('SCROLLINTOVIEW called on', this.getAttribute && this.getAttribute('data-photo-id'), JSON.stringify(args));
      return orig.apply(this, args);
    };
    const origScrollTo = window.scrollTo;
    window.scrollTo = function(...args) {
      console.log('window.scrollTo called with', JSON.stringify(args));
